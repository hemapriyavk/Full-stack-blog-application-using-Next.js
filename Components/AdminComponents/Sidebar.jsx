    ...
    <div className='flex flex-col bg-slate-100'>
        ...
        <div className='w-28 sm:w-80 h-[100vh] relative py-12 border border-black'>
            ...
            <Link href='/admin/addProduct' className='flex items-center border border-black gap-3 font-medium px-3 py-2 bg-white shadow-[-5px_5px_0px_#000000]'>
             ...
             <Link href='/admin/subscription' className='flex items-center border border-black gap-3 font-medium px-3 py-2 bg-white shadow-[-5px_5px_0px_#000000] mt-5'>
                <Image src={assets?.email_icon} alt='email-icon' width={28} /><p>Add blogs</p>
            </Link>
            </div>
        </div>
    </div>
